...
It is very proper to apply the Belief Propagation method to the tree-structured vessels with global optimization nature. In our application, the energy term is defined as:
\begin{equation}
...
\begin{equation}
V_{p,q}(f_{p}, f_{q}) = (1+\frac{nRouteCount-1}{MAX\_DEPTH})*()
\end{equation}
